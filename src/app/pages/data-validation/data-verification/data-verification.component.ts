...
export class DataVerificationComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    //   this.selectedRecords = navigation.extras.state['data'];
    //   console.log('Received records:', this.selectedRecords); // Log received records
    // } else {
    //   console.error('No data passed for verification.');
    // }
